...
$images_0 = newimages($img0,$compress,TRUE,$file_extension); //these are the transparent images resized, compressed 90% and converted into webp if the browser support webp 
...
$images_1 = newimages($img1,$compress,FALSE,$file_extension); // these are the jpeg images resized with a 90% of compression and no transparency and converted into webp if the browser support webp 
...
$images_2 = newimages($img2,$compress,FALSE,$file_extension); // these are the jpeg images resized with a 90% of compression and no transparency and converted into webp if the browser support webp 
...
$images_3 = newimages($img3,$compress,FALSE,$file_extension); // these are the jpeg images resized with a 90% of compression and no transparency and converted into webp if the browser support webp 
...
$images_4 = newimages($img4,$compress,FALSE,$file_extension); // these are the jpeg images resized with a 90% of compression and no transparency and converted into webp if the browser support webp 
