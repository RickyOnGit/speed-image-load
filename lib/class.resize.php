...
$newfilename = "./".$directoryName."/".$res_1."_".$dest_imagex."x".$dest_imagey."_".$q.".png";   
        break; 
    case "image/bmp":
$newfilename = "./".$directoryName."/".$res_1."_".$dest_imagex."x".$dest_imagey."_".$q.".bmp";
        break;
    case "image/webp":
...
switch ($size['mime']) { 
    ...
    case "image/png": 
        ...
        break; 
    case "image/bmp": 
        $im = imagecreatefrombmp($this->Scr);
        $fF= 'bmp'; 
        break;
    case "image/webp": 
...
switch ($size['mime']) { 
    ...
    case "image/png": 
        ...
        break; 
    case "image/bmp": 
        $newimg = imagebmp($dest_image, $newfilename, $this->Compr);
        break;
    case "image/webp": 
